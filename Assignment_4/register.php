            ...
            <main class="mdl-layout__content">
                    ...
                    <div class='mdl-card mdl-shadow--4dp login-form'>
                        ...
                        <form action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>' method='POST'>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="email" name="email-input">
                ...
                function connect_db($email, $user, $pass, $sq, $ans) {
                    ...
                    try {
                        ...
                        $sql = "INSERT INTO users (email, username, password, question, answer, privilages) VALUES ('$email', '$user', '$pass_hash', '$sq', '$ans_hash', '2')";
